...
## Motivation
Targeting for The Merge to occur mid-September 2022, trying to merge before block times noticeably slow down.
...
Precise increases in block times are very difficult to predict, especially after the bomb is already noticeable.
